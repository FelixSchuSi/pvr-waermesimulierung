...
public class ThreadCountTestCasesConstant {
    private static final ConfigEntityBuilder singleThread = defaultConfig().setStepCount(100).setThreadCount(1).setHeight(250).setLength(250).setWidth(250).setImplementationEnum(ImplementationEnum.SINGLE_THREADED);
