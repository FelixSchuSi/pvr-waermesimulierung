...
public class MainView extends VerticalLayout implements BeforeEnterObserver {
    ...
    private BaseConfigEntity parseConfig(QueryParameters queryParameters) {
        ...
        return new ConfigEntityBuilder()
                ...
                .setDisplayLength(Integer.parseInt(map.get("displayLength").get(0)))
                .setDisplayWidth(Integer.parseInt(map.get("displayWidth").get(0)))
                .setDisplayHeight(Integer.parseInt(map.get("displayHeight").get(0)))
