...
public class LinearLeftSideConfigEntity extends BaseConfigEntity {
    ...
    public LinearLeftSideConfigEntity(int length, int width, int height, Integer displayLength, Integer displayWidth, Integer displayHeight, int zIndex, Double startTemp, Double sideTempFront, Double sideTempBack, Double sideTempBottom, Double sideTempTop, Double sideTempRight, Double alpha, Integer stepCount, Integer threadCount, ImplementationEnum implementationEnum, Double sideTempLeftCenter, Double sideTempLeftBorder) {
