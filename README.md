...
```
cd existing_repo
git remote add origin https://git.fh-muenster.de/fs988544/pvr-waermesimulierung.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.fh-muenster.de/fs988544/pvr-waermesimulierung/-/settings/integrations)
